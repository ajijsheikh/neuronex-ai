      ...
      uploadTask.on(
        ...
        async () => {
          ...
          try {
            ...
            setFiles((prev) => prev.map((f) => (f.file.name === file.name ? { ...f, status: "done" } : f)));
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Drag and drop files to add to your knowledge base.</p>
      </div>
      ...
      <div className="text-xs text-muted-foreground space-y-1.5">
        ...
        <div className="flex items-center gap-2">
          <div className="h-1 w-1 rounded-full bg-muted-foreground" />
          <span>Future: Images, Web URLs, GitHub Repos</span>
        </div>
      </div>
